			...
			switch(glow.light_color)
				if(COLOR_SOFT_RED)
					if(glow.even_cycle)
						...
						SET_LIGHT_RANGE_POWER_COLOR(glow, glow.base_light_range * DISCO_INFENO_RANGE, glow.light_power * 1.48, LIGHT_COLOR_BLUE)
						glow.set_light_on(TRUE)
				if(LIGHT_COLOR_BLUE)
					if(glow.even_cycle)
						SET_LIGHT_RANGE_POWER_COLOR(glow, glow.base_light_range * DISCO_INFENO_RANGE, glow.light_power * 2, LIGHT_COLOR_GREEN)
						glow.set_light_on(TRUE)
					else
						glow.set_light_on(FALSE)
				...
				if(LIGHT_COLOR_GREEN)
					if(glow.even_cycle)
						...
						SET_LIGHT_RANGE_POWER_COLOR(glow, glow.base_light_range * DISCO_INFENO_RANGE, glow.light_power * 0.5, LIGHT_COLOR_ORANGE)
						glow.set_light_on(TRUE)
				if(LIGHT_COLOR_ORANGE)
					if(glow.even_cycle)
						SET_LIGHT_RANGE_POWER_COLOR(glow, glow.base_light_range * DISCO_INFENO_RANGE, glow.light_power * 2.27, LIGHT_COLOR_PURPLE)
						glow.set_light_on(TRUE)
					else
						glow.set_light_on(FALSE)
				...
				if(LIGHT_COLOR_PURPLE)
					if(glow.even_cycle)
						...
						SET_LIGHT_RANGE_POWER_COLOR(glow, glow.base_light_range * DISCO_INFENO_RANGE, glow.light_power * 0.44, LIGHT_COLOR_BLUEGREEN)
						glow.set_light_on(TRUE)
				...
				if(LIGHT_COLOR_CYAN)
					if(glow.even_cycle)
						SET_LIGHT_RANGE_POWER_COLOR(glow, glow.base_light_range * DISCO_INFENO_RANGE, glow.light_power * 0.68, COLOR_SOFT_RED)
						glow.set_light_on(TRUE)
					else
						glow.set_light_on(FALSE)
